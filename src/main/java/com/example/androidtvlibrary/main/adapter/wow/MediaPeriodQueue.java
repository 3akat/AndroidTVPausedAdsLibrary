...
/* package */ final class MediaPeriodQueue {
    ...
    private @TestPlayer.RepeatMode int repeatMode;
    ...
    /**
     * Sets the {@link TestPlayer.RepeatMode} and returns whether the repeat mode change has been fully handled.
     * If not, it is necessary to seek to the current playback position.
     */
    public boolean updateRepeatMode(@TestPlayer.RepeatMode int repeatMode) {
