...
public class MediaPeriodHolder {
     ...
     * @throws Exception If an error occurs during track selection.
     */
    public void handlePrepared(float playbackSpeed, Timeline timeline) throws Exception {
        prepared = true;
        trackGroups = mediaPeriod.getTrackGroups();
        Log.e("aaaaTrackGroups", String.valueOf(trackGroups.length));
    ...
    public TrackSelectorResult selectTracks(float playbackSpeed, Timeline timeline)
            throws Exception {
        Log.e("aaagetTrackGroups", String.valueOf(getTrackGroups().length));
