...
public class DefaultRenderersFactory implements RenderersFactory {
     ...
     *     directly to {@link SimpleWowPlayer.Builder}.
     */
    @Deprecated
    ...
    protected void buildVideoRenderers(
        ...
        try {
            ...
            // LINT.IfChange
            Class<?> clazz = Class.forName("LibvpxVideoRenderer");
        ...
        try {
            // Full class names used for constructor args so the LINT rule triggers if any of them move.
            // LINT.IfChange
            Class<?> clazz = Class.forName("Libgav1VideoRenderer");
            Constructor<?> constructor =
                    clazz.getConstructor(
                            long.class,
                            android.os.Handler.class,
    ...
    protected void buildMetadataRenderers(
            Context context,
            TestPlayer.MetadataOutput output,
            Looper outputLooper,
            @ExtensionRendererMode int extensionRendererMode,
            ArrayList<Renderer> out) {
