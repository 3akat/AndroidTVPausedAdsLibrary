...
public final class AudioFocusManager {
     ...
     */
    @PlayerCommand
    public int updateAudioFocus(boolean playWhenReady, @TestPlayer.State int playbackState) {
    ...
    private boolean shouldAbandonAudioFocus(@TestPlayer.State int playbackState) {
        return playbackState == TestPlayer.STATE_IDLE || focusGain != C.AUDIOFOCUS_GAIN;
    }
