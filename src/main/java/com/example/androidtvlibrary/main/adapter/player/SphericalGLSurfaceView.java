...
public final class SphericalGLSurfaceView extends GLSurfaceView {
    ...
    @Nullable private TestPlayer.VideoComponent videoComponent;
    ...
    /** Sets the {@link TestPlayer.VideoComponent} to use. */
    public void setVideoComponent(@Nullable TestPlayer.VideoComponent newVideoComponent) {
