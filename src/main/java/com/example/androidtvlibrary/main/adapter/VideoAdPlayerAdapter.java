 ...
 */
public class VideoAdPlayerAdapter
...
//        videoPlayer.pause();
    ...
    public void pauseAd() {
        Log.i(LOGTAG, "pauseAd");
        this.pauseAd(loadedAdMediaInfo);
//        pauseAd(loadedAdMediaInfo);
        savedAdPosition = videoPlayer.getCurrentPosition();
        videoPlayer.pause();
    ...
    public void resumeAd() {
        Log.i(LOGTAG, "resumeAd");
        Log.i("LOGTAGAAAA", String.valueOf(savedAdPosition));
        this.playAd(loadedAdMediaInfo);
//        playAd(loadedAdMediaInfo);
//        videoPlayer.start();
        videoPlayer.seekTo(savedAdPosition);
//
        for (VideoAdPlayer.VideoAdPlayerCallback callback : videoAdPlayerCallbacks) {
            callback.onResume(loadedAdMediaInfo);
        }
    }
