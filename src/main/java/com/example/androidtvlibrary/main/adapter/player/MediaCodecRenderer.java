...
import com.example.androidtvlibrary.main.adapter.Media.extractor.NalUnitUtil;
...
public abstract class MediaCodecRenderer extends BaseRenderer {
    ...
    @Override
    @Capabilities
    public final int supportsFormat(Format format) throws Exception {
        try {
    ...
    protected final void maybeInitCodec() throws Exception {
    ...
    @Override
    public final void setOperatingRate(float operatingRate) throws Exception {
     ...
     * @throws Exception If an error occurs re-instantiating the codec.
     */
    ...
    private boolean readToFlagsOnlyBuffer(boolean requireFormat) throws Exception {
     ...
     * @throws Exception If an error occurs feeding the input buffer.
     */
    ...
    private boolean shouldWaitForKeys(boolean bufferEncrypted) throws Exception {
        if (codecDrmSession == null
                || (!bufferEncrypted
     ...
     * @throws Exception If an error occurs re-initializing the {@link MediaCodec}.
     */
    @SuppressWarnings("unchecked")
    protected void onInputFormatChanged(FormatHolder formatHolder) throws Exception {
     ...
     * @throws Exception Thrown if an error occurs handling the new output media format.
     */
     ...
     * @throws Exception Thrown if an error occurs handling supplemental data.
     */
     ...
     *
     * @throws Exception If an error occurs releasing or initializing a codec.
     */
    private void updateCodecOperatingRate() throws Exception {
        if (Util.SDK_INT < 23) {
            return;
        }
     ...
     *
     * @throws Exception If an error occurs updating the codec's DRM session.
     */
    private void drainAndUpdateCodecDrmSession() throws Exception {
        if (Util.SDK_INT < 23) {
     ...
     * buffers have been queued to the codec.
     *
     * @throws Exception If an error occurs re-initializing a codec.
     */
     ...
     * @throws Exception If an error occurs draining the output buffer.
     */
    ...
    private void processOutputFormat() throws Exception {
     ...
     * @throws Exception If an error occurs processing the output buffer.
     */
     ...
     * The default implementation is a no-op.
     *
     * @throws Exception Thrown if an error occurs rendering remaining output.
     */
    protected void renderToEndOfStream() throws Exception {
        // Do nothing.
    }
     ...
     *
     * @throws Exception If an error occurs processing the signal.
     */
    ...
    @TargetApi(23)
    private void updateDrmSessionOrReinitializeCodecV23() throws Exception {
