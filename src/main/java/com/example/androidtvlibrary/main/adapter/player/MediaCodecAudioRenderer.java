...
public class MediaCodecAudioRenderer extends MediaCodecRenderer implements MediaClock {
    ...
    public MediaCodecAudioRenderer(
            ...
            com.example.androidtvlibrary.main.adapter.player.AudioProcessor... audioProcessors) {
        this(
                context,
                mediaCodecSelector,
                drmSessionManager,
    ...
    protected List<MediaCodecInfo> getDecoderInfos(
        ...
        if (allowPassthrough(format.channelCount, mimeType)) {
            @Nullable
            MediaCodecInfo passthroughDecoderInfo = null;
            try {
                passthroughDecoderInfo = mediaCodecSelector.getPassthroughDecoderInfo();
            } catch (Exception e) {
                throw new RuntimeException(e);
            }
