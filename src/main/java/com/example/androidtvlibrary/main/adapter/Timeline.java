...
public abstract class Timeline {
    ...
    public static final class Period {
        ...
        public Period set(
            ...
            return set(id, uid, windowIndex, durationUs, positionInWindowUs, AdPlaybackStateTest.NONE);
        }
        ...
        public Period set(
                ...
                long durationUs,
                long positionInWindowUs,
                AdPlaybackStateTest adPlaybackState) {
            this.id = id;
            this.uid = uid;
        ...
        public boolean isAdAvailable(int adGroupIndex, int adIndexInAdGroup) {
            ...
            return adGroup.count != C.LENGTH_UNSET
                    && adGroup.states[adIndexInAdGroup] != AdPlaybackStateTest.AD_STATE_UNAVAILABLE;
        }
     ...
     */
    public int getNextWindowIndex(int windowIndex, @TestPlayer.RepeatMode int repeatMode,
     ...
     */
    public int getPreviousWindowIndex(int windowIndex, @TestPlayer.RepeatMode int repeatMode,
                                      boolean shuffleModeEnabled) {
        switch (repeatMode) {
            case TestPlayer.REPEAT_MODE_OFF:
