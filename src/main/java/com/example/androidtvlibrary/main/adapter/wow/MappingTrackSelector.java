...
public abstract class MappingTrackSelector extends TrackSelector {
     ...
     * @throws Exception If an error occurs finding a renderer.
     */
     ...
     * @throws Exception If an error occurs determining the format support.
     */
    @RendererCapabilities.Capabilities
     ...
     *     renderer.
     * @throws Exception If an error occurs determining the adaptation support.
     */
    @RendererCapabilities.AdaptiveSupport
    private static int[] getMixedMimeTypeAdaptationSupports(
            RendererCapabilities[] rendererCapabilities) throws Exception {
