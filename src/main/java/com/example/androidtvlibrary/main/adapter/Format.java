...
public final class Format implements Parcelable {
    ...
    @Nullable public final Class<? extends com.example.androidtvlibrary.main.adapter.wow.ExoMediaCrypto> exoMediaCryptoType;
    ...
    /* package */ Format(
            ...
            int accessibilityChannel,
            // Provided by source.
            @Nullable Class<? extends com.example.androidtvlibrary.main.adapter.wow.ExoMediaCrypto> exoMediaCryptoType) {
        this.id = id;
        this.label = label;
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        return selectionFlags == other.selectionFlags
                ...
                && areEqual(exoMediaCryptoType, other.exoMediaCryptoType)
                && areEqual(id, other.id)
                && areEqual(label, other.label)
                && areEqual(codecs, other.codecs)
                && areEqual(containerMimeType, other.containerMimeType)
                && areEqual(sampleMimeType, other.sampleMimeType)
                && areEqual(language, other.language)
                && Arrays.equals(projectionData, other.projectionData)
                && areEqual(metadata, other.metadata)
                && areEqual(colorInfo, other.colorInfo)
                && areEqual(drmInitData, other.drmInitData)
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        writeBoolean(dest, projectionData != null);
