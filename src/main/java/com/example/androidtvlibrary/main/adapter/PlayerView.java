...
public class PlayerView extends FrameLayout implements AdsLoaderTest.AdViewProvider {
    ...
    @Nullable
    private PlayerViewCallback onTouchCallback;

    public interface PlayerViewCallback {
        void onTouchPlayerView();
    }

    public void setOnTouchCallback(PlayerViewCallback onTouchCallback) {
...
//            subtitleView = null;
        ...
        int shutterColor = 0;
        int playerLayoutId = R.layout.wow_player_view;
...
//        }
    ...
    public boolean dispatchKeyEvent(KeyEvent event) {
        if (player != null && player.isPlayingAd()) {
            if (this.getVisibility() == View.VISIBLE &&
                ...
                onTouchCallback.onTouchPlayerView();
            }
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        Log.e("aaaaaaaTouch", String.valueOf(ev.getAction()));
