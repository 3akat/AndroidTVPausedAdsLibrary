...
/* package */ final class PlaybackInfo {
    ...
    @Nullable public final Exception playbackError;
    ...
    public PlaybackInfo(
            ...
            @Nullable Exception playbackError,
            boolean isLoading,
    ...
    public MediaSource.MediaPeriodId getDummyFirstMediaPeriodId(
        ...
        return new MediaSource.MediaPeriodId(timeline.getUidOfPeriod(firstPeriodIndex), windowSequenceNumber);
    }
     ...
     */
    @CheckResult
    public PlaybackInfo copyWithPlaybackError(@Nullable Exception playbackError) {
        return new PlaybackInfo(
                timeline,
                periodId,
                startPositionUs,
