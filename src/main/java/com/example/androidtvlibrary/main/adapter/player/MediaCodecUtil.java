...
import com.example.androidtvlibrary.main.adapter.ColorInfo;
...
public final class MediaCodecUtil {
    ...
    /**
     * Returns profile and level (as defined by {@link android.media.MediaCodecInfo.CodecProfileLevel}) corresponding to the codec
    ...
    private static ArrayList<MediaCodecInfo> getDecoderInfosInternal(
        ...
        try {
            ...
            for (int i = 0; i < numberOfCodecs; i++) {
                ...
                try {
                    android.media.MediaCodecInfo.CodecCapabilities capabilities = codecInfo.getCapabilitiesForType(codecMimeType);
                    boolean tunnelingSupported =
                            mediaCodecList.isFeatureSupported(
                                    android.media.MediaCodecInfo.CodecCapabilities.FEATURE_TunneledPlayback, codecMimeType, capabilities);
                    ...
                    boolean secureSupported =
                            mediaCodecList.isFeatureSupported(
                                    android.media.MediaCodecInfo.CodecCapabilities.FEATURE_SecurePlayback, codecMimeType, capabilities);
    ...
    private static final class MediaCodecListCompatV16 implements MediaCodecListCompat {
        ...
        @Override
        public boolean isFeatureSupported(
                String feature, String mimeType, android.media.MediaCodecInfo.CodecCapabilities capabilities) {
            // Secure decoders weren't explicitly listed prior to API level 21. We assume that a secure
            // H264 decoder exists.
            return android.media.MediaCodecInfo.CodecCapabilities.FEATURE_SecurePlayback.equals(feature)
    ...
    static {
        ...
        AVC_LEVEL_NUMBER_TO_CONST.put(11, android.media.MediaCodecInfo.CodecProfileLevel.AVCLevel11);
