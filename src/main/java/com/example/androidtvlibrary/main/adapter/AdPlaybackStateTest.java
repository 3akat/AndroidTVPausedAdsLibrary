...
public final class AdPlaybackStateTest {
    ...
    public static final class AdGroup {
        ...
        public final @Nullable Uri[] uris;
        ...
        private AdGroup(
                int count, @AdState int[] states, @Nullable Uri[] uris, long[] durationsUs) {
        ...
        public AdGroup withAdCount(int count) {
            ...
            @Nullable Uri[] uris = Arrays.copyOf(this.uris, count);
        ...
        public AdGroup withAdUri(Uri uri, int index) {
            ...
            @Nullable Uri[] uris = Arrays.copyOf(this.uris, states.length);
            uris[index] = uri;
        ...
        public AdGroup withAdDurationsUs(long[] durationsUs) {
            checkArgument(count == C.LENGTH_UNSET || durationsUs.length <= this.uris.length);
    ...
    public static final AdPlaybackStateTest NONE = new AdPlaybackStateTest();
    ...
    public AdPlaybackStateTest(long... adGroupTimesUs) {
    ...
    public boolean isAdInErrorState(int adGroupIndex, int adIndexInAdGroup) {
        ...
        return adGroup.states[adIndexInAdGroup] == AdPlaybackStateTest.AD_STATE_ERROR;
    }
     ...
     */
    @CheckResult
    public AdPlaybackStateTest withAdCount(int adGroupIndex, int adCount) {
        checkArgument(adCount > 0);
        if (adGroups[adGroupIndex].count == adCount) {
            return this;
        }
        AdGroup[] adGroups = nullSafeArrayCopy(this.adGroups, this.adGroups.length);
        adGroups[adGroupIndex] = this.adGroups[adGroupIndex].withAdCount(adCount);
        return new AdPlaybackStateTest(adGroupTimesUs, adGroups, adResumePositionUs, contentDurationUs);
    }

    /** Returns an instance with the specified ad URI. */
    @CheckResult
    public AdPlaybackStateTest withAdUri(int adGroupIndex, int adIndexInAdGroup, Uri uri) {
        AdGroup[] adGroups = nullSafeArrayCopy(this.adGroups, this.adGroups.length);
    ...
    @CheckResult
    public AdPlaybackStateTest withPlayedAd(int adGroupIndex, int adIndexInAdGroup) {
        AdGroup[] adGroups = nullSafeArrayCopy(this.adGroups, this.adGroups.length);
    ...
    @CheckResult
    public AdPlaybackStateTest withSkippedAd(int adGroupIndex, int adIndexInAdGroup) {
        AdGroup[] adGroups = nullSafeArrayCopy(this.adGroups, this.adGroups.length);
    ...
    @CheckResult
    public AdPlaybackStateTest withAdLoadError(int adGroupIndex, int adIndexInAdGroup) {
        AdGroup[] adGroups = nullSafeArrayCopy(this.adGroups, this.adGroups.length);
     ...
     */
    @CheckResult
    public AdPlaybackStateTest withSkippedAdGroup(int adGroupIndex) {
        AdGroup[] adGroups = nullSafeArrayCopy(this.adGroups, this.adGroups.length);
    ...
    @CheckResult
    public AdPlaybackStateTest withAdDurationsUs(long[][] adDurationUs) {
        AdGroup[] adGroups = nullSafeArrayCopy(this.adGroups, this.adGroups.length);
     ...
     */
    @CheckResult
    public AdPlaybackStateTest withAdResumePositionUs(long adResumePositionUs) {
    ...
    @CheckResult
    public AdPlaybackStateTest withContentDurationUs(long contentDurationUs) {
    ...
    public boolean equals(@Nullable Object o) {
        ...
        AdPlaybackStateTest that = (AdPlaybackStateTest) o;
