...
import com.example.androidtvlibrary.main.adapter.StatsDataSource;
    ...
    private void maybeFinishPrepare() {
        ...
        for (int i = 0; i < trackCount; i++) {
            ...
            if (trackFormat.drmInitData != null) {
                trackFormat =
                        trackFormat.copyWithExoMediaCryptoType(drmSessionManager.getExoMediaCryptoType(trackFormat.drmInitData)
                        );
//                drmSessionManager.getExoMediaCryptoType(trackFormat.drmInitData)
    ...
    /* package */ final class ExtractingLoadable implements Loader.Loadable, IcyDataSource.Listener {
        ...
        private DataSpecTest buildDataSpec(long position) {
            ...
            return new DataSpecTest(
                    ...
                    C.LENGTH_UNSET,
                    customCacheKey,
                    DataSpecTest.FLAG_DONT_CACHE_IF_LENGTH_UNKNOWN | DataSpecTest.FLAG_ALLOW_CACHE_FRAGMENTATION,
