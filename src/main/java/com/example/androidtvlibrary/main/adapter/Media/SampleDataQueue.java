...
import com.example.androidtvlibrary.main.adapter.wow.Allocation;
...
public class SampleDataQueue {
 private static final int INITIAL_SCRATCH_SIZE = 32;
    ...
    public void sampleData(com.example.androidtvlibrary.main.adapter.Media.ParsableByteArray buffer, int length) {
        while (length > 0) {
