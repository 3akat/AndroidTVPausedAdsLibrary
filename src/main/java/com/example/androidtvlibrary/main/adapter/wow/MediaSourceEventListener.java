...
public interface MediaSourceEventListener {
     ...
     * level retry (TestPlayer.EventListener#onPlayerError} is the appropriate place to implement
    ...
    final class EventDispatcher {
        ...
        public void loadStarted(DataSpecTest dataSpec, int dataType, long elapsedRealtimeMs) {
            loadStarted(
                    dataSpec,
                    dataType,
