...
public interface HttpDataSource extends DataSource {
    ...
    class HttpDataSourceException extends IOException {
         ...
         */
        public final DataSpecTest dataSpec;

        public HttpDataSourceException(DataSpecTest dataSpec, @Type int type) {
            super();
            this.dataSpec = dataSpec;
            this.type = type;
        }

        public HttpDataSourceException(String message, DataSpecTest dataSpec, @Type int type) {
            super(message);
            this.dataSpec = dataSpec;
            this.type = type;
        }

        public HttpDataSourceException(IOException cause, DataSpecTest dataSpec, @Type int type) {
            super(cause);
            this.dataSpec = dataSpec;
            this.type = type;
        }

        public HttpDataSourceException(String message, IOException cause, DataSpecTest dataSpec,
                                       @Type int type) {
            super(message, cause);
            this.dataSpec = dataSpec;
            this.type = type;
    ...
    final class InvalidContentTypeException extends HttpDataSourceException {
        ...
        public InvalidContentTypeException(String contentType, DataSpecTest dataSpec) {
    ...
    final class InvalidResponseCodeException extends HttpDataSourceException {
        ...
        /** @deprecated Use {@link #InvalidResponseCodeException(int, String, Map, DataSpecTest)}. */
        @Deprecated
        public InvalidResponseCodeException(
                int responseCode, Map<String, List<String>> headerFields, DataSpecTest dataSpec) {
     ...
     */
    @Override
    long open(DataSpecTest dataSpec) throws HttpDataSourceException;
